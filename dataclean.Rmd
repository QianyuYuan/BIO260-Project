...
## select variables
business_clean<-business_simple%>%select(business_id,full_address,zip,categories,city,review_count,neighborhoods,longitude,state,stars,latitude,`attributes.Price Range`,`attributes.Accepts Credit Cards`)
